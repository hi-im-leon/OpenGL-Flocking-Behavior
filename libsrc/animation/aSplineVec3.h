...
{
public:
    enum InterpolationType { LINEAR, CUBIC_BERNSTEIN, CUBIC_CASTELJAU, CUBIC_HERMITE, CUBIC_MATRIX };
...
{
public:
    AHermiteInterpolatorVec3() : ACubicInterpolatorVec3(ASplineVec3::CUBIC_HERMITE) {}
